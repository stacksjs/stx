...
```typescript
import { Accessibility16Icon, Accessibility24Icon, AccessibilityInset16Icon } from '@stacksjs/iconify-octicon'
...
// With color
const coloredIcon = Accessibility24Icon({ color: 'red' })

// With multiple props
const customIcon = AccessibilityInset16Icon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    ...
    user: Accessibility24Icon({ size: 24, color: '#4a90e2' }),
    settings: AccessibilityInset16Icon({ size: 32 })
  }
@endjs
...
```html
@js
  import { Accessibility16Icon, Accessibility24Icon, AccessibilityInset16Icon, AccessibilityInset24Icon } from '@stacksjs/iconify-octicon'

  global.navIcons = {
    home: Accessibility16Icon({ size: 20, class: 'nav-icon' }),
    about: Accessibility24Icon({ size: 20, class: 'nav-icon' }),
    contact: AccessibilityInset16Icon({ size: 20, class: 'nav-icon' }),
    settings: AccessibilityInset24Icon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { Accessibility16Icon } from '@stacksjs/iconify-octicon'
...
const warningIcon = Accessibility24Icon({ size: 16, color: '#f59e0b' })
const errorIcon = AccessibilityInset16Icon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { Accessibility16Icon, Accessibility24Icon } from '@stacksjs/iconify-octicon'
