...
```typescript
import { AddCircle16Icon, AddCircle20Icon, AddCircle24Icon } from '@stacksjs/iconify-fluent-color'

// Basic usage
const icon = AddCircle16Icon()

// With size
const sizedIcon = AddCircle16Icon({ size: 24 })

// With color
const coloredIcon = AddCircle20Icon({ color: 'red' })

// With multiple props
const customIcon = AddCircle24Icon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    home: AddCircle16Icon({ size: 24 }),
    user: AddCircle20Icon({ size: 24, color: '#4a90e2' }),
    settings: AddCircle24Icon({ size: 32 })
  }
@endjs
...
```typescript
// Via color property
const redIcon = AddCircle16Icon({ color: 'red' })
const blueIcon = AddCircle16Icon({ color: '#4a90e2' })

// Via inline style
const greenIcon = AddCircle16Icon({ style: 'color: green;' })

// Via CSS class
const themedIcon = AddCircle16Icon({ class: 'text-primary' })
```
...
const icon24 = AddCircle16Icon({ size: 24 })
const icon1em = AddCircle16Icon({ size: '1em' })

// Set individual dimensions
const customIcon = AddCircle16Icon({ width: 24, height: 32 })

// Only set height (width calculated from ratio)
const heightOnly = AddCircle16Icon({ height: '1em' })
```
...
```typescript
const smallIcon = AddCircle16Icon({ class: 'icon-small' })
const largeIcon = AddCircle16Icon({ class: 'icon-large' })
```
...
```html
@js
  import { AddCircle16Icon, AddCircle20Icon, AddCircle24Icon, AddCircle28Icon } from '@stacksjs/iconify-fluent-color'

  global.navIcons = {
    home: AddCircle16Icon({ size: 20, class: 'nav-icon' }),
    about: AddCircle20Icon({ size: 20, class: 'nav-icon' }),
    contact: AddCircle24Icon({ size: 20, class: 'nav-icon' }),
    settings: AddCircle28Icon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { AddCircle16Icon } from '@stacksjs/iconify-fluent-color'
...
const successIcon = AddCircle16Icon({ size: 16, color: '#22c55e' })
const warningIcon = AddCircle20Icon({ size: 16, color: '#f59e0b' })
const errorIcon = AddCircle24Icon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { AddCircle16Icon, AddCircle20Icon } from '@stacksjs/iconify-fluent-color'
   const icon = AddCircle16Icon({ size: 24 })

   // Also works (data + renderIcon)
   import { addCircle16, addCircle20 } from '@stacksjs/iconify-fluent-color'
   import { renderIcon } from '@stacksjs/iconify-core'
   const icon = renderIcon(addCircle16, { size: 24 })
   ```
...
3. **Cache Rendered Icons**: Render once and reuse multiple times
   ...
   @js
     import { AddCircle16Icon } from '@stacksjs/iconify-fluent-color'
     global.icon = AddCircle16Icon({ size: 24 })
   @endjs
...
4. **Use CSS for Theming**: Apply consistent styling through CSS classes
   ...
   ```typescript
   const icon = AddCircle16Icon({ class: 'icon' })
   ```
