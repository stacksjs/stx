...
<body>
  <div class="icon-grid">
    <AcademicCapIcon size="24" />
    <AcademicCapLineIcon size="24" color="#4a90e2" />
...
```html
<AcademicCapIcon class="majesticons-icon" />
```
...
<nav>
  ...
  <a href="/about"><AcademicCapLineIcon size="20" class="nav-icon" /> About</a>
  <a href="/contact"><AddColumnIcon size="20" class="nav-icon" /> Contact</a>
  <a href="/settings"><AddColumnLineIcon size="20" class="nav-icon" /> Settings</a>
</nav>
...
<div class="status-grid">
  ...
  <div class="status-item">
    <AcademicCapLineIcon size="16" color="#f59e0b" />
    <span>Warning</span>
  </div>
  <div class="status-item">
