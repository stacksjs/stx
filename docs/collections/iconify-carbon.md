...
```typescript
import { 3dCursorIcon, 3dCursorAltIcon, 3dCurveAutoColonIcon } from '@stacksjs/iconify-carbon'

// Basic usage
const icon = 3dCursorIcon()

// With size
const sizedIcon = 3dCursorIcon({ size: 24 })

// With color
const coloredIcon = 3dCursorAltIcon({ color: 'red' })

// With multiple props
const customIcon = 3dCurveAutoColonIcon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    home: 3dCursorIcon({ size: 24 }),
    user: 3dCursorAltIcon({ size: 24, color: '#4a90e2' }),
    settings: 3dCurveAutoColonIcon({ size: 32 })
  }
@endjs
...
```typescript
// Via color property
const redIcon = 3dCursorIcon({ color: 'red' })
const blueIcon = 3dCursorIcon({ color: '#4a90e2' })

// Via inline style
const greenIcon = 3dCursorIcon({ style: 'color: green;' })

// Via CSS class
const themedIcon = 3dCursorIcon({ class: 'text-primary' })
```
...
const icon24 = 3dCursorIcon({ size: 24 })
const icon1em = 3dCursorIcon({ size: '1em' })

// Set individual dimensions
const customIcon = 3dCursorIcon({ width: 24, height: 32 })

// Only set height (width calculated from ratio)
const heightOnly = 3dCursorIcon({ height: '1em' })
```
...
```typescript
const smallIcon = 3dCursorIcon({ class: 'icon-small' })
const largeIcon = 3dCursorIcon({ class: 'icon-large' })
```
...
```html
@js
  import { 3dCursorIcon, 3dCursorAltIcon, 3dCurveAutoColonIcon, 3dCurveAutoVesselsIcon } from '@stacksjs/iconify-carbon'

  global.navIcons = {
    home: 3dCursorIcon({ size: 20, class: 'nav-icon' }),
    about: 3dCursorAltIcon({ size: 20, class: 'nav-icon' }),
    contact: 3dCurveAutoColonIcon({ size: 20, class: 'nav-icon' }),
    settings: 3dCurveAutoVesselsIcon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { 3dCursorIcon } from '@stacksjs/iconify-carbon'
...
const successIcon = 3dCursorIcon({ size: 16, color: '#22c55e' })
const warningIcon = 3dCursorAltIcon({ size: 16, color: '#f59e0b' })
const errorIcon = 3dCurveAutoColonIcon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 3dCursorIcon, 3dCursorAltIcon } from '@stacksjs/iconify-carbon'
   const icon = 3dCursorIcon({ size: 24 })

   // Also works (data + renderIcon)
   import { 3dCursor, 3dCursorAlt } from '@stacksjs/iconify-carbon'
   import { renderIcon } from '@stacksjs/iconify-core'
   const icon = renderIcon(3dCursor, { size: 24 })
   ```
...
3. **Cache Rendered Icons**: Render once and reuse multiple times
   ...
   @js
     import { 3dCursorIcon } from '@stacksjs/iconify-carbon'
     global.icon = 3dCursorIcon({ size: 24 })
   @endjs
...
4. **Use CSS for Theming**: Apply consistent styling through CSS classes
   ...
   ```typescript
   const icon = 3dCursorIcon({ class: 'icon' })
   ```
