...
```typescript
import { A11yAccessibilityDisabilityIcon, A11yAccessibilityDisabilityBoldIcon, AbTestingMonitorsIcon } from '@stacksjs/iconify-streamline-ultimate'

// Basic usage
const icon = A11yAccessibilityDisabilityIcon()

// With size
const sizedIcon = A11yAccessibilityDisabilityIcon({ size: 24 })

// With color
const coloredIcon = A11yAccessibilityDisabilityBoldIcon({ color: 'red' })

// With multiple props
const customIcon = AbTestingMonitorsIcon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    home: A11yAccessibilityDisabilityIcon({ size: 24 }),
    user: A11yAccessibilityDisabilityBoldIcon({ size: 24, color: '#4a90e2' }),
    settings: AbTestingMonitorsIcon({ size: 32 })
  }
@endjs
...
```typescript
// Via color property
const redIcon = A11yAccessibilityDisabilityIcon({ color: 'red' })
const blueIcon = A11yAccessibilityDisabilityIcon({ color: '#4a90e2' })

// Via inline style
const greenIcon = A11yAccessibilityDisabilityIcon({ style: 'color: green;' })

// Via CSS class
const themedIcon = A11yAccessibilityDisabilityIcon({ class: 'text-primary' })
```
...
const icon24 = A11yAccessibilityDisabilityIcon({ size: 24 })
const icon1em = A11yAccessibilityDisabilityIcon({ size: '1em' })

// Set individual dimensions
const customIcon = A11yAccessibilityDisabilityIcon({ width: 24, height: 32 })

// Only set height (width calculated from ratio)
const heightOnly = A11yAccessibilityDisabilityIcon({ height: '1em' })
```
...
```typescript
const smallIcon = A11yAccessibilityDisabilityIcon({ class: 'icon-small' })
const largeIcon = A11yAccessibilityDisabilityIcon({ class: 'icon-large' })
```
...
```html
@js
  import { A11yAccessibilityDisabilityIcon, A11yAccessibilityDisabilityBoldIcon, AbTestingMonitorsIcon, AbTestingMonitorsBoldIcon } from '@stacksjs/iconify-streamline-ultimate'

  global.navIcons = {
    home: A11yAccessibilityDisabilityIcon({ size: 20, class: 'nav-icon' }),
    about: A11yAccessibilityDisabilityBoldIcon({ size: 20, class: 'nav-icon' }),
    contact: AbTestingMonitorsIcon({ size: 20, class: 'nav-icon' }),
    settings: AbTestingMonitorsBoldIcon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { A11yAccessibilityDisabilityIcon } from '@stacksjs/iconify-streamline-ultimate'
...
const successIcon = A11yAccessibilityDisabilityIcon({ size: 16, color: '#22c55e' })
const warningIcon = A11yAccessibilityDisabilityBoldIcon({ size: 16, color: '#f59e0b' })
const errorIcon = AbTestingMonitorsIcon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { A11yAccessibilityDisabilityIcon, A11yAccessibilityDisabilityBoldIcon } from '@stacksjs/iconify-streamline-ultimate'
   const icon = A11yAccessibilityDisabilityIcon({ size: 24 })

   // Also works (data + renderIcon)
   import { a11yAccessibilityDisability, a11yAccessibilityDisabilityBold } from '@stacksjs/iconify-streamline-ultimate'
   import { renderIcon } from '@stacksjs/iconify-core'
   const icon = renderIcon(a11yAccessibilityDisability, { size: 24 })
   ```
...
3. **Cache Rendered Icons**: Render once and reuse multiple times
   ...
   @js
     import { A11yAccessibilityDisabilityIcon } from '@stacksjs/iconify-streamline-ultimate'
     global.icon = A11yAccessibilityDisabilityIcon({ size: 24 })
   @endjs
...
4. **Use CSS for Theming**: Apply consistent styling through CSS classes
   ...
   ```typescript
   const icon = A11yAccessibilityDisabilityIcon({ class: 'icon' })
   ```
