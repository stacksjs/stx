...
```typescript
import { 3dGlassesIcon, 3dSyncIcon, AccountIcon } from '@stacksjs/iconify-streamline-cyber'
...
```html
@js
  import { 3dGlassesIcon, 3dSyncIcon, AccountIcon, AccountGroup1Icon } from '@stacksjs/iconify-streamline-cyber'
  ...
  global.navIcons = {
    ...
    settings: AccountGroup1Icon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { 3dGlassesIcon } from '@stacksjs/iconify-streamline-cyber'
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 3dGlassesIcon, 3dSyncIcon } from '@stacksjs/iconify-streamline-cyber'
