...
```typescript
import { ACaneIcon, AbdominalIcon, AbnormalIcon } from '@stacksjs/iconify-icon-park'
...
```html
@js
  import { ACaneIcon, AbdominalIcon, AbnormalIcon, AccelerationIcon } from '@stacksjs/iconify-icon-park'
...
```typescript
import { ACaneIcon } from '@stacksjs/iconify-icon-park'
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { ACaneIcon, AbdominalIcon } from '@stacksjs/iconify-icon-park'
