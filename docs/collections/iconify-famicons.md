...
<body>
  <div class="icon-grid">
    <AccessibilityIcon size="24" />
    <AccessibilityOutlineIcon size="24" color="#4a90e2" />
    <AccessibilitySharpIcon size="32" class="my-icon" />
  </div>
</body>
</html>
```
...
```html
<AccessibilityIcon class="famicons-icon" />
```
...
<nav>
  ...
  <a href="/about"><AccessibilityOutlineIcon size="20" class="nav-icon" /> About</a>
  <a href="/contact"><AccessibilitySharpIcon size="20" class="nav-icon" /> Contact</a>
  <a href="/settings"><AddIcon size="20" class="nav-icon" /> Settings</a>
</nav>
...
<div class="status-grid">
  ...
  <div class="status-item">
    <AccessibilityOutlineIcon size="16" color="#f59e0b" />
    <span>Warning</span>
  </div>
  <div class="status-item">
    <AccessibilitySharpIcon size="16" color="#ef4444" />
    <span>Error</span>
  </div>
</div>
```
