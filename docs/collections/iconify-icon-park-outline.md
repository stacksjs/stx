...
<body>
  <div class="icon-grid">
    <ACaneIcon size="24" />
    <AbdominalIcon size="24" color="#4a90e2" />
    <AbnormalIcon size="32" class="my-icon" />
  </div>
</body>
</html>
```
...
```html
<ACaneIcon class="iconParkOutline-icon" />
```
...
<nav>
  ...
  <a href="/about"><AbdominalIcon size="20" class="nav-icon" /> About</a>
  <a href="/contact"><AbnormalIcon size="20" class="nav-icon" /> Contact</a>
  <a href="/settings"><AccelerationIcon size="20" class="nav-icon" /> Settings</a>
</nav>
...
<div class="status-grid">
  ...
  <div class="status-item">
    <AbdominalIcon size="16" color="#f59e0b" />
    <span>Warning</span>
  </div>
  <div class="status-item">
    <AbnormalIcon size="16" color="#ef4444" />
    <span>Error</span>
  </div>
</div>
```
