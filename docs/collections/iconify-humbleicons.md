...
```html
<ActivityIcon class="humbleicons-icon" />
```
...
<nav>
  ...
  <a href="/contact"><AiIcon size="20" class="nav-icon" /> Contact</a>
  <a href="/settings"><AidIcon size="20" class="nav-icon" /> Settings</a>
</nav>
