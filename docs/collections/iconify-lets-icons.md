...
```typescript
import { 10Icon, 10LightIcon, 3dBoxIcon } from '@stacksjs/iconify-lets-icons'

// Basic usage
const icon = 10Icon()

// With size
const sizedIcon = 10Icon({ size: 24 })

// With color
const coloredIcon = 10LightIcon({ color: 'red' })

// With multiple props
const customIcon = 3dBoxIcon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    home: 10Icon({ size: 24 }),
    user: 10LightIcon({ size: 24, color: '#4a90e2' }),
    settings: 3dBoxIcon({ size: 32 })
  }
@endjs
...
```typescript
// Via color property
const redIcon = 10Icon({ color: 'red' })
const blueIcon = 10Icon({ color: '#4a90e2' })

// Via inline style
const greenIcon = 10Icon({ style: 'color: green;' })

// Via CSS class
const themedIcon = 10Icon({ class: 'text-primary' })
```
...
const icon24 = 10Icon({ size: 24 })
const icon1em = 10Icon({ size: '1em' })

// Set individual dimensions
const customIcon = 10Icon({ width: 24, height: 32 })

// Only set height (width calculated from ratio)
const heightOnly = 10Icon({ height: '1em' })
```
...
```typescript
const smallIcon = 10Icon({ class: 'icon-small' })
const largeIcon = 10Icon({ class: 'icon-large' })
```
...
```html
@js
  import { 10Icon, 10LightIcon, 3dBoxIcon, 3dBoxDuotoneIcon } from '@stacksjs/iconify-lets-icons'

  global.navIcons = {
    home: 10Icon({ size: 20, class: 'nav-icon' }),
    about: 10LightIcon({ size: 20, class: 'nav-icon' }),
    contact: 3dBoxIcon({ size: 20, class: 'nav-icon' }),
    settings: 3dBoxDuotoneIcon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { 10Icon } from '@stacksjs/iconify-lets-icons'
...
const successIcon = 10Icon({ size: 16, color: '#22c55e' })
const warningIcon = 10LightIcon({ size: 16, color: '#f59e0b' })
const errorIcon = 3dBoxIcon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 10Icon, 10LightIcon } from '@stacksjs/iconify-lets-icons'
   const icon = 10Icon({ size: 24 })

   // Also works (data + renderIcon)
   import { 10, 10Light } from '@stacksjs/iconify-lets-icons'
   import { renderIcon } from '@stacksjs/iconify-core'
   const icon = renderIcon(10, { size: 24 })
   ```
