...
```typescript
import { AboutIcon, AboutFilledIcon, AddIcon } from '@stacksjs/iconify-ix'
...
// With color
const coloredIcon = AboutFilledIcon({ color: 'red' })
...
@js
  ...
  global.icons = {
    ...
    user: AboutFilledIcon({ size: 24, color: '#4a90e2' }),
...
```html
@js
  import { AboutIcon, AboutFilledIcon, AddIcon, AddApplicationIcon } from '@stacksjs/iconify-ix'

  global.navIcons = {
    home: AboutIcon({ size: 20, class: 'nav-icon' }),
    about: AboutFilledIcon({ size: 20, class: 'nav-icon' }),
    contact: AddIcon({ size: 20, class: 'nav-icon' }),
    settings: AddApplicationIcon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { AboutIcon } from '@stacksjs/iconify-ix'
...
const warningIcon = AboutFilledIcon({ size: 16, color: '#f59e0b' })
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { AboutIcon, AboutFilledIcon } from '@stacksjs/iconify-ix'
