...
```typescript
import { AcademicCapIcon, AdjustmentsIcon, AdjustmentsHorizontalIcon } from '@stacksjs/iconify-heroicons-outline'
...
```html
@js
  import { AcademicCapIcon, AdjustmentsIcon, AdjustmentsHorizontalIcon, AdjustmentsVerticalIcon } from '@stacksjs/iconify-heroicons-outline'
...
```typescript
import { AcademicCapIcon } from '@stacksjs/iconify-heroicons-outline'
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { AcademicCapIcon, AdjustmentsIcon } from '@stacksjs/iconify-heroicons-outline'
