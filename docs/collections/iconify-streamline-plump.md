...
```typescript
import { 3dCoordinateAxisIcon, 3dCoordinateAxisRemixIcon, 3dCoordinateAxisSolidIcon } from '@stacksjs/iconify-streamline-plump'
...
// With color
const coloredIcon = 3dCoordinateAxisRemixIcon({ color: 'red' })

// With multiple props
const customIcon = 3dCoordinateAxisSolidIcon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    ...
    user: 3dCoordinateAxisRemixIcon({ size: 24, color: '#4a90e2' }),
    settings: 3dCoordinateAxisSolidIcon({ size: 32 })
  }
@endjs
...
```html
@js
  import { 3dCoordinateAxisIcon, 3dCoordinateAxisRemixIcon, 3dCoordinateAxisSolidIcon, AddBellNotificationIcon } from '@stacksjs/iconify-streamline-plump'

  global.navIcons = {
    home: 3dCoordinateAxisIcon({ size: 20, class: 'nav-icon' }),
    about: 3dCoordinateAxisRemixIcon({ size: 20, class: 'nav-icon' }),
    contact: 3dCoordinateAxisSolidIcon({ size: 20, class: 'nav-icon' }),
    settings: AddBellNotificationIcon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { 3dCoordinateAxisIcon } from '@stacksjs/iconify-streamline-plump'
...
const warningIcon = 3dCoordinateAxisRemixIcon({ size: 16, color: '#f59e0b' })
const errorIcon = 3dCoordinateAxisSolidIcon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 3dCoordinateAxisIcon, 3dCoordinateAxisRemixIcon } from '@stacksjs/iconify-streamline-plump'
