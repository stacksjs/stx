...
```typescript
import { 123Icon, 0CircleIcon, 0CircleFillIcon } from '@stacksjs/iconify-bi'

// Basic usage
const icon = 123Icon()

// With size
const sizedIcon = 123Icon({ size: 24 })

// With color
const coloredIcon = 0CircleIcon({ color: 'red' })

// With multiple props
const customIcon = 0CircleFillIcon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    home: 123Icon({ size: 24 }),
    user: 0CircleIcon({ size: 24, color: '#4a90e2' }),
    settings: 0CircleFillIcon({ size: 32 })
  }
@endjs
...
```typescript
// Via color property
const redIcon = 123Icon({ color: 'red' })
const blueIcon = 123Icon({ color: '#4a90e2' })

// Via inline style
const greenIcon = 123Icon({ style: 'color: green;' })

// Via CSS class
const themedIcon = 123Icon({ class: 'text-primary' })
```
...
const icon24 = 123Icon({ size: 24 })
const icon1em = 123Icon({ size: '1em' })

// Set individual dimensions
const customIcon = 123Icon({ width: 24, height: 32 })

// Only set height (width calculated from ratio)
const heightOnly = 123Icon({ height: '1em' })
```
...
```typescript
const smallIcon = 123Icon({ class: 'icon-small' })
const largeIcon = 123Icon({ class: 'icon-large' })
```
...
```html
@js
  import { 123Icon, 0CircleIcon, 0CircleFillIcon, 0SquareIcon } from '@stacksjs/iconify-bi'

  global.navIcons = {
    home: 123Icon({ size: 20, class: 'nav-icon' }),
    about: 0CircleIcon({ size: 20, class: 'nav-icon' }),
    contact: 0CircleFillIcon({ size: 20, class: 'nav-icon' }),
    settings: 0SquareIcon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { 123Icon } from '@stacksjs/iconify-bi'
...
const successIcon = 123Icon({ size: 16, color: '#22c55e' })
const warningIcon = 0CircleIcon({ size: 16, color: '#f59e0b' })
const errorIcon = 0CircleFillIcon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 123Icon, 0CircleIcon } from '@stacksjs/iconify-bi'
   const icon = 123Icon({ size: 24 })

   // Also works (data + renderIcon)
   import { 123, 0Circle } from '@stacksjs/iconify-bi'
   import { renderIcon } from '@stacksjs/iconify-core'
   const icon = renderIcon(123, { size: 24 })
   ```
