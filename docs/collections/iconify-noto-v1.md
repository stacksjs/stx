...
```typescript
import { 1stPlaceMedalIcon, 2ndPlaceMedalIcon, 3rdPlaceMedalIcon } from '@stacksjs/iconify-noto-v1'
...
```html
@js
  import { 1stPlaceMedalIcon, 2ndPlaceMedalIcon, 3rdPlaceMedalIcon, AButtonBloodTypeIcon } from '@stacksjs/iconify-noto-v1'
...
```typescript
import { 1stPlaceMedalIcon } from '@stacksjs/iconify-noto-v1'
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 1stPlaceMedalIcon, 2ndPlaceMedalIcon } from '@stacksjs/iconify-noto-v1'
