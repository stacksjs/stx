...
```typescript
import { 3dCoordinateAxisIcon, 3dCoordinateAxisRemixIcon, 3dCoordinateAxisSolidIcon } from '@stacksjs/iconify-streamline-flex'
...
```html
@js
  import { 3dCoordinateAxisIcon, 3dCoordinateAxisRemixIcon, 3dCoordinateAxisSolidIcon, 3dRotate1Icon } from '@stacksjs/iconify-streamline-flex'
  ...
  global.navIcons = {
    ...
    settings: 3dRotate1Icon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { 3dCoordinateAxisIcon } from '@stacksjs/iconify-streamline-flex'
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 3dCoordinateAxisIcon, 3dCoordinateAxisRemixIcon } from '@stacksjs/iconify-streamline-flex'
