...
```typescript
import { 0Icon, 1Icon, 2Icon } from '@stacksjs/iconify-fa6-solid'
...
```html
@js
  import { 0Icon, 1Icon, 2Icon, 3Icon } from '@stacksjs/iconify-fa6-solid'
...
```typescript
import { 0Icon } from '@stacksjs/iconify-fa6-solid'
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 0Icon, 1Icon } from '@stacksjs/iconify-fa6-solid'
