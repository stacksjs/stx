...
```typescript
import { 3dIcon, 3dBoldIcon, 3dDuotoneIcon } from '@stacksjs/iconify-iconamoon'
...
// With color
const coloredIcon = 3dBoldIcon({ color: 'red' })

// With multiple props
const customIcon = 3dDuotoneIcon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    home: 3dIcon({ size: 24 }),
    user: 3dBoldIcon({ size: 24, color: '#4a90e2' }),
    settings: 3dDuotoneIcon({ size: 32 })
  }
@endjs
...
```html
@js
  import { 3dIcon, 3dBoldIcon, 3dDuotoneIcon, 3dFillIcon } from '@stacksjs/iconify-iconamoon'

  global.navIcons = {
    home: 3dIcon({ size: 20, class: 'nav-icon' }),
    about: 3dBoldIcon({ size: 20, class: 'nav-icon' }),
    contact: 3dDuotoneIcon({ size: 20, class: 'nav-icon' }),
    settings: 3dFillIcon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { 3dIcon } from '@stacksjs/iconify-iconamoon'
...
const warningIcon = 3dBoldIcon({ size: 16, color: '#f59e0b' })
const errorIcon = 3dDuotoneIcon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 3dIcon, 3dBoldIcon } from '@stacksjs/iconify-iconamoon'
