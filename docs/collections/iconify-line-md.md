...
<body>
  <div class="icon-grid">
    <AccountIcon size="24" />
    <AccountAddIcon size="24" color="#4a90e2" />
    <AccountAlertIcon size="32" class="my-icon" />
  </div>
</body>
</html>
```
...
<nav>
  ...
  <a href="/about"><AccountAddIcon size="20" class="nav-icon" /> About</a>
  <a href="/contact"><AccountAlertIcon size="20" class="nav-icon" /> Contact</a>
  <a href="/settings"><AccountAlertLoopIcon size="20" class="nav-icon" /> Settings</a>
</nav>
...
<div class="status-grid">
  ...
  <div class="status-item">
    <AccountAddIcon size="16" color="#f59e0b" />
    <span>Warning</span>
  </div>
  <div class="status-item">
    <AccountAlertIcon size="16" color="#ef4444" />
    <span>Error</span>
  </div>
</div>
```
