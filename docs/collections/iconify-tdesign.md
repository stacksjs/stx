...
<body>
  <div class="icon-grid">
    <AccessibilityIcon size="24" />
    <AccessibilityFilledIcon size="24" color="#4a90e2" />
    <ActivityIcon size="32" class="my-icon" />
  </div>
</body>
</html>
```
...
```html
<AccessibilityIcon class="tdesign-icon" />
```
...
<nav>
  ...
  <a href="/about"><AccessibilityFilledIcon size="20" class="nav-icon" /> About</a>
  <a href="/contact"><ActivityIcon size="20" class="nav-icon" /> Contact</a>
  <a href="/settings"><ActivityFilledIcon size="20" class="nav-icon" /> Settings</a>
</nav>
...
<div class="status-grid">
  ...
  <div class="status-item">
    <AccessibilityFilledIcon size="16" color="#f59e0b" />
    <span>Warning</span>
  </div>
  <div class="status-item">
    <ActivityIcon size="16" color="#ef4444" />
    <span>Error</span>
  </div>
</div>
```
