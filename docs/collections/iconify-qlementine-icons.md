...
<body>
  <div class="icon-grid">
    <Accessibility16Icon size="24" />
    <Accordion16Icon size="24" color="#4a90e2" />
    <AddFile16Icon size="32" class="my-icon" />
  </div>
</body>
</html>
```
...
```html
<Accessibility16Icon class="qlementineIcons-icon" />
```
...
<nav>
  ...
  <a href="/about"><Accordion16Icon size="20" class="nav-icon" /> About</a>
  <a href="/contact"><AddFile16Icon size="20" class="nav-icon" /> Contact</a>
  <a href="/settings"><AddFolder16Icon size="20" class="nav-icon" /> Settings</a>
</nav>
...
<div class="status-grid">
  ...
  <div class="status-item">
    <Accordion16Icon size="16" color="#f59e0b" />
    <span>Warning</span>
  </div>
  <div class="status-item">
    <AddFile16Icon size="16" color="#ef4444" />
    <span>Error</span>
  </div>
</div>
```
