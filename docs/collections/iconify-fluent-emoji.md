...
To see all available icons, explore the package source or check the [Iconify website](https://icon-sets.iconify.design/fluent-emoji/).
...
```html
@js
  import { 1stPlaceMedal, 2ndPlaceMedal, 3rdPlaceMedal, aButtonBloodType } from '@stacksjs/iconify-fluent-emoji'
  import { renderIcon } from '@stacksjs/iconify-core'
...
```typescript
import * as icons from '@stacksjs/iconify-fluent-emoji'
import { renderIcon } from '@stacksjs/iconify-core'
...
1. **Import Only What You Need**: Use named imports to enable tree-shaking
   ```typescript
   // Good
   import { 1stPlaceMedal, 2ndPlaceMedal } from '@stacksjs/iconify-fluent-emoji'
