...
```typescript
import { 1stPlaceMedalIcon, 2ndPlaceMedalIcon, 3rdPlaceMedalIcon } from '@stacksjs/iconify-fluent-emoji'
...
```html
@js
  import { 1stPlaceMedalIcon, 2ndPlaceMedalIcon, 3rdPlaceMedalIcon, AButtonBloodTypeIcon } from '@stacksjs/iconify-fluent-emoji'
...
```typescript
import { 1stPlaceMedalIcon } from '@stacksjs/iconify-fluent-emoji'
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 1stPlaceMedalIcon, 2ndPlaceMedalIcon } from '@stacksjs/iconify-fluent-emoji'
