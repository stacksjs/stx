...
```typescript
import { 500pxIcon, AccessibleIconIcon, AccusoftIcon } from '@stacksjs/iconify-la'
...
```html
@js
  import { 500pxIcon, AccessibleIconIcon, AccusoftIcon, AcquisitionsIncorporatedIcon } from '@stacksjs/iconify-la'
...
```typescript
import { 500pxIcon } from '@stacksjs/iconify-la'
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 500pxIcon, AccessibleIconIcon } from '@stacksjs/iconify-la'
