...
```typescript
import { 3dMoveIcon, 3dMoveRemixIcon, 3dMoveSolidIcon } from '@stacksjs/iconify-streamline-sharp'
...
// With color
const coloredIcon = 3dMoveRemixIcon({ color: 'red' })

// With multiple props
const customIcon = 3dMoveSolidIcon({
  size: 32,
  color: '#4a90e2',
  class: 'my-icon'
})
...
@js
  ...
  global.icons = {
    ...
    user: 3dMoveRemixIcon({ size: 24, color: '#4a90e2' }),
    settings: 3dMoveSolidIcon({ size: 32 })
  }
@endjs
...
```html
@js
  import { 3dMoveIcon, 3dMoveRemixIcon, 3dMoveSolidIcon, 3dRotateXAxisRemixIcon } from '@stacksjs/iconify-streamline-sharp'

  global.navIcons = {
    home: 3dMoveIcon({ size: 20, class: 'nav-icon' }),
    about: 3dMoveRemixIcon({ size: 20, class: 'nav-icon' }),
    contact: 3dMoveSolidIcon({ size: 20, class: 'nav-icon' }),
    settings: 3dRotateXAxisRemixIcon({ size: 20, class: 'nav-icon' })
  }
@endjs
...
```typescript
import { 3dMoveIcon } from '@stacksjs/iconify-streamline-sharp'
...
const warningIcon = 3dMoveRemixIcon({ size: 16, color: '#f59e0b' })
const errorIcon = 3dMoveSolidIcon({ size: 16, color: '#ef4444' })
```
...
1. **Use Component Functions**: Import component functions for cleaner code
   ```typescript
   // Recommended
   import { 3dMoveIcon, 3dMoveRemixIcon } from '@stacksjs/iconify-streamline-sharp'
