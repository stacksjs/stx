...
<body>
  <div class="icon-grid">
    <500pxIcon size="24" />
    <AddFilesIcon size="24" color="#4a90e2" />
...
```html
<500pxIcon class="lineicons-icon" />
```
...
<nav>
  ...
  <a href="/about"><AddFilesIcon size="20" class="nav-icon" /> About</a>
  <a href="/contact"><AdobeIcon size="20" class="nav-icon" /> Contact</a>
  <a href="/settings"><AdonisIcon size="20" class="nav-icon" /> Settings</a>
</nav>
...
<div class="status-grid">
  ...
  <div class="status-item">
    <AddFilesIcon size="16" color="#f59e0b" />
    <span>Warning</span>
  </div>
  <div class="status-item">
