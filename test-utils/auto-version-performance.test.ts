...
describe('Auto-version Performance Tests', () => {
  ...
  describe('Performance Requirements', () => {
    test('should complete small repository in under 5 seconds', async () => {
      ...
      console.warn(`✅ Small repo: ${result.duration.toFixed(2)}s (${result.commitsAnalyzed} commits)`)
    })
    ...
    test('should complete medium repository in under 15 seconds', async () => {
      ...
      console.warn(`✅ Medium repo: ${result.duration.toFixed(2)}s (${result.commitsAnalyzed} commits)`)
    })
    ...
    test('should complete large repository within 20 seconds (requirement)', async () => {
      ...
      console.warn(`✅ Large repo: ${result.duration.toFixed(2)}s (${result.commitsAnalyzed} commits)`)
    })
  })
  ...
  describe('Performance Optimizations', () => {
    test('should handle commit parsing efficiently', async () => {
      ...
      console.warn(`✅ Commit parsing: ${duration.toFixed(3)}s for 50 commits`)
    })
    ...
    test('should handle version bump logic efficiently', () => {
      ...
      console.warn(`✅ Version logic: ${duration.toFixed(4)}s for 100 commits`)
    })
  })
  ...
  describe('Stress Tests', () => {
    test('should handle multiple concurrent operations', async () => {
      ...
      results.forEach((result, index) => {
        ...
        console.warn(`✅ Concurrent ${index + 1}: ${result.duration.toFixed(2)}s`)
      })
    })
    ...
    test('should maintain performance under memory pressure', async () => {
      ...
      console.warn(`✅ Memory pressure test: ${result.duration.toFixed(2)}s`)
    })
  })
  ...
  describe('Real-world Scenarios', () => {
    test('should handle project with many tags efficiently', async () => {
      ...
      console.warn(`✅ Many tags test: ${duration.toFixed(3)}s for 100 tags`)
    })
    ...
    test('should handle mixed commit types from real project', async () => {
      ...
      console.warn(`✅ Real project commits: ${duration.toFixed(4)}s for ${realCommitTypes.length} commits`)
    })
  })
  ...
  describe('Performance Monitoring', () => {
    test('should provide performance metrics', async () => {
      ...
      console.warn(`   Duration: ${result.duration.toFixed(2)}s`)
      console.warn(`   Commits: ${result.commitsAnalyzed}`)
      console.warn(`   Rate: ${commitsPerSecond.toFixed(1)} commits/sec`)
    })

    test('should warn when approaching time limit', async () => {
      const mockExec = mock(async (_command: string) => {
