...
export const signature: IconData = {
  "body": "<path fill=\"#1565C0\" d=\"M38.8 28.2C41.5 24.8 45 20.1 45 12c0-.6-.4-1-1-1s-1 .4-1 1c0 6.7-2.5 10.7-5 13.9c-.6-1.9-1-4.2-1-6.9c0-.5-.4-1-1-1c-.5 0-1 .4-1 1c-.1 1.7-.6 3.6-1 3.8c-.4 0-.9-1.4-1-2.8c0-.5-.5-.9-1-.9s-1 .3-1 .9c-.3 1.7-1.1 4.1-2 4.1c-.4 0-.6-.1-.7-.3c-.3-.3-.4-1-.4-1.6c0-.4.1-.8.1-1.2c0-.5-.4-1-.9-1s-1 .3-1.1.8c0 .1-.1.5-.1 1.1c-.2 1.7-.8 5.1-2.9 5.1c-.7 0-1.1-.2-1.4-.7c-.5-.8-.5-2.1 0-3.3v-.1c.1-.1.1-.3.2-.4c.8-1.6 1.7-2.5 3.2-2.5c.6 0 1-.4 1-1s-.4-1-1-1c-4.2 0-5.4 4.1-6.6 8c-1.4 4.8-2.7 8-6.4 8c-5.1 0-7-6.6-7-11c0-8.6 4.7-14 9-14c2.9 0 4 2.3 4.1 2.4c.2.5.8.7 1.3.5s.7-.8.5-1.3C19.8 10.4 18.2 7 14 7C8.6 7 3 13 3 23c0 10.3 5.9 13 9 13c5.1 0 6.8-4.5 8.1-8.5c.7.9 1.7 1.5 2.9 1.5c2.2 0 3.5-1.6 4.2-3.6q.75.6 1.8.6c1.4 0 2.4-1.2 3-2.4c.4.7 1.1 1.2 2 1.2c.6 0 1.1-.3 1.5-.7c.3 1.4.7 2.7 1 3.8c-1.4 1.8-2.5 3.3-2.5 5.1c0 1.7 1.3 3 3 3c1.8 0 3-1.6 3-3c0-1.3-.5-2.7-1.1-4.3c0-.2-.1-.3-.1-.5M37 34c-.7 0-1-.5-1-1c0-.9.5-1.8 1.3-2.9c.4 1.2.7 2.1.7 2.9c0 .3-.3 1-1 1\"/><path fill=\"#90A4AE\" d=\"M3 40h42v2H3z\"/>",
  "width": 48,
  "height": 48,
  "viewBox": "0 0 48 48"
}
