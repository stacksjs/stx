...
export const channel48Regular: IconData = {
  "body": "<path fill=\"currentColor\" d=\"M6.189 10.72A6.25 6.25 0 0 1 12.25 6h23.5A6.25 6.25 0 0 1 42 12.25v23.5A6.25 6.25 0 0 1 35.75 42h-23.5A6.25 6.25 0 0 1 6 35.75V18.21a4 4 0 0 0 2.5.165V35.75a3.75 3.75 0 0 0 3.75 3.75h23.5a3.75 3.75 0 0 0 3.75-3.75v-23.5a3.75 3.75 0 0 0-3.75-3.75h-23.5a3.75 3.75 0 0 0-3.427 2.224A4 4 0 0 0 7.5 10.5c-.46 0-.9.077-1.311.22M6 12.5c-.607.456-1 1.182-1 2A2.496 2.496 0 0 0 7.5 17A2.5 2.5 0 1 0 6 12.5M17.25 19a1.25 1.25 0 1 0 0 2.5h13.5a1.25 1.25 0 1 0 0-2.5zM16 27.25c0-.69.56-1.25 1.25-1.25h9.5a1.25 1.25 0 1 1 0 2.5h-9.5c-.69 0-1.25-.56-1.25-1.25\"/>",
  "width": 48,
  "height": 48,
  "viewBox": "0 0 48 48"
}
