...
export const brainCircuit24Filled: IconData = {
  "body": "<path fill=\"currentColor\" d=\"M9.5 2c.645 0 1.245.188 1.75.512V7.25H9.854a2 2 0 1 0 0 1.5h1.396v12.495A3.74 3.74 0 0 1 8.994 22c-1.726 0-3.195-1.187-3.627-2.8A4 4 0 0 1 2 15.25V15c0-.947.33-1.815.88-2.5H6.5a.75.75 0 0 1 .746.673l.004.077v.396a2 2 0 1 0 1.5 0v-.396l-.012-.23A2.25 2.25 0 0 0 6.5 11H3.814a3.876 3.876 0 0 1 2.468-6.205A3.25 3.25 0 0 1 9.5 2m5 0a3.25 3.25 0 0 1 3.218 2.795a3.876 3.876 0 0 1 2.08 6.633A4 4 0 0 1 22 15v.25a4 4 0 0 1-3.367 3.95c-.431 1.613-1.901 2.8-3.627 2.8a3.74 3.74 0 0 1-2.256-.755V16.5h1.75a2.25 2.25 0 0 0 2.25-2.25v-.898A1.999 1.999 0 0 0 16 9.5a2 2 0 0 0-.75 3.852v.898a.75.75 0 0 1-.75.75h-1.75V2.512A3.23 3.23 0 0 1 14.5 2M8 15a.5.5 0 1 1 0 1a.5.5 0 0 1 0-1m8-4a.5.5 0 1 1 0 1a.5.5 0 0 1 0-1M8 7.5a.5.5 0 1 1 0 1a.5.5 0 0 1 0-1\"/>",
  "width": 24,
  "height": 24,
  "viewBox": "0 0 24 24"
}
