...
export const healthMedicalRibbon2RibbonMedicalCancerHealthBeautySymbol: IconData = {
...
export default healthMedicalRibbon2RibbonMedicalCancerHealthBeautySymbol
