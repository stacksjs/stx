...
export const interfaceCalendarCheckApproveCalendarCheckDateDayMonthSuccess: IconData = {
...
export default interfaceCalendarCheckApproveCalendarCheckDateDayMonthSuccess
