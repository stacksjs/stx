...
export const travelAirportArrivalTimePlaneAirplaneTripLandTravelTimeAdventureTimerClock: IconData = {
...
export default travelAirportArrivalTimePlaneAirplaneTripLandTravelTimeAdventureTimerClock
