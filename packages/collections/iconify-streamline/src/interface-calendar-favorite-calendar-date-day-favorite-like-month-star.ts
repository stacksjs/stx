...
export const interfaceCalendarFavoriteCalendarDateDayFavoriteLikeMonthStar: IconData = {
...
export default interfaceCalendarFavoriteCalendarDateDayFavoriteLikeMonthStar
