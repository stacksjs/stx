...
export const travelHotelThreeStarThreeStarsReviewsReviewRatingHotelStar: IconData = {
...
export default travelHotelThreeStarThreeStarsReviewsReviewRatingHotelStar
