...
export const interfaceArrowsSynchronizeArrowsLoadingLoadSyncSynchronizeArrowReload: IconData = {
...
export default interfaceArrowsSynchronizeArrowsLoadingLoadSyncSynchronizeArrowReload
