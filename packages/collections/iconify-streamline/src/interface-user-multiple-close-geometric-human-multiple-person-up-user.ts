...
export const interfaceUserMultipleCloseGeometricHumanMultiplePersonUpUser: IconData = {
...
export default interfaceUserMultipleCloseGeometricHumanMultiplePersonUpUser
