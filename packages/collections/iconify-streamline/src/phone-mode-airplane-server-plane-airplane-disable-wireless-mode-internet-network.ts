...
export const phoneModeAirplaneServerPlaneAirplaneDisableWirelessModeInternetNetwork: IconData = {
...
export default phoneModeAirplaneServerPlaneAirplaneDisableWirelessModeInternetNetwork
