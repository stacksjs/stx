...
export const entertainmentTicketHobbyTicketEventEntertainmentStubTheater: IconData = {
...
export default entertainmentTicketHobbyTicketEventEntertainmentStubTheater
