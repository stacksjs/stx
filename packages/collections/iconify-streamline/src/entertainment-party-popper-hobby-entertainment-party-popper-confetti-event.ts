...
export const entertainmentPartyPopperHobbyEntertainmentPartyPopperConfettiEvent: IconData = {
...
export default entertainmentPartyPopperHobbyEntertainmentPartyPopperConfettiEvent
