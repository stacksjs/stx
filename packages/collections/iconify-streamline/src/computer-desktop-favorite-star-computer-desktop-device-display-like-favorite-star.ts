...
export const computerDesktopFavoriteStarComputerDesktopDeviceDisplayLikeFavoriteStar: IconData = {
...
export default computerDesktopFavoriteStarComputerDesktopDeviceDisplayLikeFavoriteStar
