...
export const foodSteakCookGrillSteakBbqCookingNutritionBarbecueGrillingFood: IconData = {
...
export default foodSteakCookGrillSteakBbqCookingNutritionBarbecueGrillingFood
