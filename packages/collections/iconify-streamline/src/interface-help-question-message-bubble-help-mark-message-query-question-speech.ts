...
export const interfaceHelpQuestionMessageBubbleHelpMarkMessageQueryQuestionSpeech: IconData = {
...
export default interfaceHelpQuestionMessageBubbleHelpMarkMessageQueryQuestionSpeech
