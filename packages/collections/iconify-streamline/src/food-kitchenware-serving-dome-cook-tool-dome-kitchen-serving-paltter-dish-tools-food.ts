...
export const foodKitchenwareServingDomeCookToolDomeKitchenServingPaltterDishToolsFood: IconData = {
...
export default foodKitchenwareServingDomeCookToolDomeKitchenServingPaltterDishToolsFood
