...
export const travelAirportDepartureTimeTravelPlaneTripAirplaneTimeOffAdventureTimerTakeClock: IconData = {
...
export default travelAirportDepartureTimeTravelPlaneTripAirplaneTimeOffAdventureTimerTakeClock
