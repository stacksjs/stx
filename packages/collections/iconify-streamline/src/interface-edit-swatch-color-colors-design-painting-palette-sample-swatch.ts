...
export const interfaceEditSwatchColorColorsDesignPaintingPaletteSampleSwatch: IconData = {
...
export default interfaceEditSwatchColorColorsDesignPaintingPaletteSampleSwatch
