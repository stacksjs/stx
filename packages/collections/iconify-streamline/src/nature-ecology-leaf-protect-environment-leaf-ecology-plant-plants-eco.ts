...
export const natureEcologyLeafProtectEnvironmentLeafEcologyPlantPlantsEco: IconData = {
...
export default natureEcologyLeafProtectEnvironmentLeafEcologyPlantPlantsEco
