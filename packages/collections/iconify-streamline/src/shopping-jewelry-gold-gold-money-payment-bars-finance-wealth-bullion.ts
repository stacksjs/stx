...
export const shoppingJewelryGoldGoldMoneyPaymentBarsFinanceWealthBullion: IconData = {
...
export default shoppingJewelryGoldGoldMoneyPaymentBarsFinanceWealthBullion
