...
export const interfaceFileClipboardWorkPlainClipboardTaskListCompanyOffice: IconData = {
...
export default interfaceFileClipboardWorkPlainClipboardTaskListCompanyOffice
