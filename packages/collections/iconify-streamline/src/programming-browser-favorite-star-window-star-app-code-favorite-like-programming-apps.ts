...
export const programmingBrowserFavoriteStarWindowStarAppCodeFavoriteLikeProgrammingApps: IconData = {
...
export default programmingBrowserFavoriteStarWindowStarAppCodeFavoriteLikeProgrammingApps
