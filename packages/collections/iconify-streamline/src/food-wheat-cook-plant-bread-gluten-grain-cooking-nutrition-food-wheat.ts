...
export const foodWheatCookPlantBreadGlutenGrainCookingNutritionFoodWheat: IconData = {
...
export default foodWheatCookPlantBreadGlutenGrainCookingNutritionFoodWheat
