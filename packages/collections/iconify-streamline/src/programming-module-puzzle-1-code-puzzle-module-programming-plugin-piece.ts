...
export const programmingModulePuzzle1CodePuzzleModuleProgrammingPluginPiece: IconData = {
...
export default programmingModulePuzzle1CodePuzzleModuleProgrammingPluginPiece
