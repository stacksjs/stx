...
export const computerDesktopSettingSettingsDesktopDisplayDeviceGearCogComputer: IconData = {
...
export default computerDesktopSettingSettingsDesktopDisplayDeviceGearCogComputer
