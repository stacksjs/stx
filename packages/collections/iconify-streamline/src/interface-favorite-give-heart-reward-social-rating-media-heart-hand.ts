...
export const interfaceFavoriteGiveHeartRewardSocialRatingMediaHeartHand: IconData = {
...
export default interfaceFavoriteGiveHeartRewardSocialRatingMediaHeartHand
