...
export const entertainmentVolumeLevelHighSpeakerHighVolumeControlAudioMusic: IconData = {
...
export default entertainmentVolumeLevelHighSpeakerHighVolumeControlAudioMusic
