...
export const tropicalFish: IconData = {
  "body": "<g fill=\"none\"><path fill=\"#635994\" d=\"M3.39 18.945a1.055 1.055 0 1 0-.671 0a1.055 1.055 0 1 0 .672 0\"/><path fill=\"#F9C23C\" d=\"M23 7h-8.625v23H23a3 3 0 0 0 3-3v-8.058c.002 2.404 1.438 4.152 2.656 4.152c.975 0 1.282-.688 1.313-1.032V16.75c0-1.425-.313-1.656-.875-1.656c-1.995 0-2.983 2.013-3.094 3.363V10a3 3 0 0 0-3-3\"/><path fill=\"#00A6ED\" d=\"M14.5 30C20.851 30 26 24.851 26 18.5S20.851 7 14.5 7a11.46 11.46 0 0 0-7.8 3.05l-.073 16.833A11.46 11.46 0 0 0 14.5 30\"/><path fill=\"#8D65C5\" d=\"M6.627 26.883A11.47 11.47 0 0 1 3 18.5a11.47 11.47 0 0 1 3.7-8.45a10.8 10.8 0 0 1 3.988 8.388c0 3.417-1.586 6.464-4.06 8.445\"/><path fill=\"#F9C23C\" d=\"M18 21.452v-5.874a.7.7 0 0 0-1.174-.516l-2.997 2.754a1 1 0 0 0 .01 1.482l2.995 2.676A.7.7 0 0 0 18 21.452\"/><path fill=\"#1C1C1C\" d=\"M8.172 16.516a.625.625 0 1 1-1.25 0a.625.625 0 0 1 1.25 0\"/></g>",
  "width": 32,
  "height": 32,
  "viewBox": "0 0 32 32"
}
