...
export const earth: IconData = {
  "body": "<g fill=\"none\"><path d=\"M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10\"/><path d=\"M12 22c5.523 0 10-4.477 10-10q0-.532-.055-1.05l-1.95 1.134l-3.509 4.067l-1.504-3.05l-3.007-1.017V8.017L8.968 7L6.963 9.034L3.05 7.55a10 10 0 0 0-1.008 3.525l5.923 2.026L4.95 19.1C6.75 20.9 9.305 22 12 22\"/><path stroke=\"currentColor\" stroke-width=\"2\" d=\"M2.041 11.089L7.965 13.1l-3.017 5.99M3.04 7.553l3.922 1.48L8.968 7l3.007 1.017v4.067l3.008 1.017l1.503 3.05l3.51-4.067l1.943-1.13M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10Z\"/></g>",
  "width": 24,
  "height": 24,
  "viewBox": "0 0 24 24"
}
