...
```bash
bun add @stx/iconify-cryptocurrency
```
...
```html
<script>
  import { home } from '@stx/iconify-cryptocurrency'
...
```typescript
import { home, account, settings } from '@stx/iconify-cryptocurrency'
import { renderIcon } from '@stx/iconify-core'
