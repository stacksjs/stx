...
export const home13: IconData = {
  "body": "<g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"1.5\"><path d=\"m22 10.5l-9.117-7.678a1.37 1.37 0 0 0-1.765 0L2 10.5\"/><path d=\"M20.5 5v10.5c0 2.828 0 4.243-.879 5.121c-.878.879-2.293.879-5.121.879h-5c-2.828 0-4.243 0-5.121-.879C3.5 19.743 3.5 18.328 3.5 15.5v-6\"/><path d=\"M10.5 11.5h-1v1h1zm4 0h-1v1h1zm-4 4h-1v1h1zm4 0h-1v1h1z\"/></g>",
  "width": 24,
  "height": 24,
  "viewBox": "0 0 24 24"
}
