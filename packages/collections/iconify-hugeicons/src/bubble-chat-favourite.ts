...
export const bubbleChatFavourite: IconData = {
  "body": "<g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"1.5\"><path d=\"M21.5 12a9.5 9.5 0 0 1-9.5 9.5c-1.628 0-3.16-.41-4.5-1.131c-1.868-1.007-3.125-.071-4.234.097a.53.53 0 0 1-.456-.156a.64.64 0 0 1-.117-.703c.436-1.025.835-2.969.29-4.607a9.5 9.5 0 0 1-.483-3a9.5 9.5 0 1 1 19 0\"/><path d=\"M12 16s-4-2.471-4-4.861c0-1.182.842-2.14 2-2.14c.6 0 1.2.207 2 1.03c.8-.823 1.4-1.03 2-1.03c1.158 0 2 .958 2 2.14c0 2.39-4 4.86-4 4.86\"/></g>",
  "width": 24,
  "height": 24,
  "viewBox": "0 0 24 24"
}
