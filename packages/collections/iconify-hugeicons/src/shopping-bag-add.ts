...
export const shoppingBagAdd: IconData = {
  "body": "<g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"1.5\"><path d=\"M20.177 12.511c-.35-3.002-.863-5.253-1.338-6.852c-.389-1.312-.584-1.968-1.382-2.563S15.843 2.5 14.211 2.5H8.79c-1.632 0-2.448 0-3.246.596c-.798.595-.993 1.251-1.382 2.563c-.475 1.599-.987 3.85-1.337 6.852c-.413 3.539-.62 5.308.573 6.648C4.591 20.5 6.524 20.5 10.392 20.5h2.216\"/><path d=\"M8.5 6.5a3 3 0 0 0 6 0m1 12h6m-3 3v-6\"/></g>",
  "width": 24,
  "height": 24,
  "viewBox": "0 0 24 24"
}
