# @stacksjs/iconify-streamline-sharp
...
```html
<script>
  import { home } from '@stacksjs/iconify-streamline-sharp'
...
```typescript
import { home, account, settings } from '@stacksjs/iconify-streamline-sharp'
import { renderIcon } from '@stacksjs/iconify-core'
