# @stacksjs/iconify-streamline-block
...
```html
<script>
  import { home } from '@stacksjs/iconify-streamline-block'
...
```typescript
import { home, account, settings } from '@stacksjs/iconify-streamline-block'
import { renderIcon } from '@stacksjs/iconify-core'
