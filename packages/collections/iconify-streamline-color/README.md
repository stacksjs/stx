# @stacksjs/iconify-streamline-color
...
```html
<script>
  import { home } from '@stacksjs/iconify-streamline-color'
...
```typescript
import { home, account, settings } from '@stacksjs/iconify-streamline-color'
import { renderIcon } from '@stacksjs/iconify-core'
