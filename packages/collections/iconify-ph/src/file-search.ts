...
export const fileSearch: IconData = {
  "body": "<path fill=\"currentColor\" d=\"M216 88a7.7 7.7 0 0 0-2.4-5.7l-55.9-56l-.6-.5h-.2l-.5-.3h-.1l-.5-.4h-.1l-.6-.3h-.1l-.7-.3H56A16 16 0 0 0 40 40v176a16 16 0 0 0 16 16h144a16 16 0 0 0 16-16V88Zm-56-36.7L188.7 80H160ZM200 216H56V40h88v48a8 8 0 0 0 8 8h48v120Zm-45.5-48.8A35.8 35.8 0 0 0 160 148a36.3 36.3 0 0 0-10.5-25.5a36 36 0 1 0-6.3 56l10.9 11a8.3 8.3 0 0 0 5.7 2.3a8.5 8.5 0 0 0 5.7-2.3a8.1 8.1 0 0 0 0-11.4Zm-44.6-5.1A19.8 19.8 0 1 1 124 168a19.7 19.7 0 0 1-14.1-5.9Z\"/>",
  "width": 256,
  "height": 256,
  "viewBox": "0 0 256 256"
}
