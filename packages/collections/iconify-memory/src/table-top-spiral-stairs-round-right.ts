...
export const tableTopSpiralStairsRoundRight: IconData = {
  "body": "<path fill=\"currentColor\" d=\"M9 6H8V5H7V4h1v1h1M4 6h1V5H4M3 7h1V6H3m2 1h1V6H5M4 8h1V7H4m2 1h1V7H6M3 9h1V8H3m2 1h1V8H5m2 1h1V8H7m2 1h1V2H8v1H6v1H5v1h1v1h1v1h1v1h1m-7 2h1V9H2m2 1h1V9H4m2 1h1V9H6m2 1h1V9H8m3 1h1V9h1V8h1V7h1V6h1V5h1V4h-1V3h-2V2h-3m6 15h1v-1h1v-2h1v-3h-8v1h1v1h1v1h1v1h1v1h1m-3 6H0v-2h2v-8H0V8h1V5h1V4h1V3h1V2h1V1h3V0h6v1h3v1h1v1h1v1h1v1h1v3h1v6h-1v3h-1v1h-1v1h-1v1h-1v1h-3m6-11V8h-1V6h-1V5h-1v1h-1v1h-1v1h-1v1h-1v1M5 20v-8H3v8m5 0v-8H6v8m5 0v-8H9v8m5 0v-1h2v-1h1v-1h-1v-1h-1v-1h-1v-1h-1v-1h-1v7Z\"/>",
  "width": 22,
  "height": 22,
  "viewBox": "0 0 22 22"
}
