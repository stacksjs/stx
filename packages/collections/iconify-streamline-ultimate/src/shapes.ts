...
export const shapes: IconData = {
  "body": "<path fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"1.5\" d=\"M1.75.75h7s1 0 1 1v7s0 1-1 1h-7s-1 0-1-1v-7s0-1 1-1m12.5 4.5a4.5 4.5 0 1 0 9.002 0a4.5 4.5 0 0 0-9.002 0m4.536 8.727a.886.886 0 0 0-1.572 0l-4.337 7.807a1.03 1.03 0 0 0-.007.976a.9.9 0 0 0 .793.49h8.674a.91.91 0 0 0 .793-.49a1.03 1.03 0 0 0-.007-.976zm-12.935-.943a.778.778 0 0 0-1.2 0l-3.71 4.437a.83.83 0 0 0 0 1.058l3.708 4.437a.78.78 0 0 0 1.2 0l3.708-4.437a.83.83 0 0 0 0-1.058z\"/>",
  "width": 24,
  "height": 24,
  "viewBox": "0 0 24 24"
}
