...
export const chartAreaStackedNormalized: IconData = {
  "body": "<g fill=\"none\"><g clip-path=\"url(#SVGFd4lJeyK)\"><path fill=\"currentColor\" fill-rule=\"evenodd\" d=\"M13.5 12.5h-11A.5.5 0 0 1 2 12v-1.611l2.812-1.985a1.25 1.25 0 0 1 1.414-.019l1.753 1.169a2.75 2.75 0 0 0 3.757-.681L14 5.728V12a.5.5 0 0 1-.5.5m.22-8.95l-3.201 4.446a1.25 1.25 0 0 1-1.708.31L7.058 7.137a2.75 2.75 0 0 0-3.111.042L2 8.553V4a.5.5 0 0 1 .5-.5h11q.119.001.22.05M.5 9.992V4a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-11a2 2 0 0 1-2-2V9.991\" clip-rule=\"evenodd\"/></g><defs><clipPath id=\"SVGFd4lJeyK\"><path fill=\"currentColor\" d=\"M0 0h16v16H0z\"/></clipPath></defs></g>",
  "width": 24,
  "height": 24,
  "viewBox": "0 0 24 24"
}
