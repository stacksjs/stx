...
export function transformSkipCode(code: string, map: Map<string, string>, SKIP_RULES_RE: RegExp, keyFlag: string): string {
...
export function restoreSkipCode(code: string, map: Map<string, string>): string {
